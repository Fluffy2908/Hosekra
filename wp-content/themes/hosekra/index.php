        ...
        <div class="features-grid">
            <div class="feature-card">
                <div class="feature-icon">
                    <?php echo hosekra_get_icon('shield'); ?>
                </div>
            ...
            <div class="feature-card">
                <div class="feature-icon">
                    <?php echo hosekra_get_icon('star'); ?>
                </div>
            ...
            <div class="feature-card">
                <div class="feature-icon">
                    <?php echo hosekra_get_icon('truck'); ?>
                </div>
                <h3>Hitra dostava</h3>
            ...
            <div class="feature-card">
                <div class="feature-icon">
                    <?php echo hosekra_get_icon('tools'); ?>
                </div>
                <h3>Ključ v roke</h3>
            ...
            <div class="feature-card">
                <div class="feature-icon">
                    <?php echo hosekra_get_icon('leaf'); ?>
                </div>
