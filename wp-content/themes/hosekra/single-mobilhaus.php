...
$model_description = hosekra_get_field('model_short_description', get_the_ID(), get_the_excerpt());
$model_full_description = hosekra_get_field('model_full_description', get_the_ID(), get_the_content());
$model_price = hosekra_get_field('model_price', get_the_ID(), 'ab €45.000');
$model_size = hosekra_get_field('model_size', get_the_ID(), '35 m²');
$model_beds = hosekra_get_field('model_beds', get_the_ID(), '2');
$model_persons = hosekra_get_field('model_persons', get_the_ID(), '4');
    ...
    <div class="container">
        ...
        <div class="other-models-grid">
            <?php while ($other_models->have_posts()) : $other_models->the_post();
                ...
                $other_size = hosekra_get_field('model_size', get_the_ID(), '35 m²');
                $other_beds = hosekra_get_field('model_beds', get_the_ID(), '2');
                $other_price = hosekra_get_field('model_price', get_the_ID(), 'ab €45.000');
            ?>
